...
local show_hide_text_id = 8
local enable_disable_text_id = 9
...
function screen_control.on_control_notify(screen, control, value)
    ...
    elseif control == show_button_id then
        ...
        set_visiable(control_screen_id, show_hide_text_id, VISIBLE_SHOW)
    elseif control == hide_button_id then
        ...
        set_visiable(control_screen_id, show_hide_text_id, VISIBLE_HIDE)
    elseif control == enable_button_id then
        ...
        set_enable(control_screen_id, enable_disable_text_id, STATE_ENABLE)
    elseif control == disable_button_id then
        ...
        set_enable(control_screen_id, enable_disable_text_id, STATE_DISABLE)
    end
end
