...
local current_test_button_1_state_text_id = 5
local get_current_test_button_1_state_button_id = 6
local test_button_2_button_id = 7
local set_test_button_2_button_id = 8
local reset_test_button_2_button_id = 9
...
function screen_button_2.on_control_notify(screen, control, value)
    ...
    elseif control == get_current_test_button_1_state_button_id and value == TOUCH_RELEASE then
        ...
        if current_button_state == TOUCH_RELEASE then
            set_text(button_2_screen_id, current_test_button_1_state_text_id, "현재 버튼 상태: 뗌")
        elseif current_button_state == TOUCH_PRESS then
            set_text(button_2_screen_id, current_test_button_1_state_text_id, "현재 버튼 상태: 누름")
        end
    elseif control == set_test_button_2_button_id and value == TOUCH_RELEASE then
        -- 테스트 버튼 2 누름 버튼 터치 시 테스트 2 버튼 누름
        set_value(button_2_screen_id, test_button_2_button_id, TOUCH_PRESS)
    elseif control == reset_test_button_2_button_id and value == TOUCH_RELEASE then
