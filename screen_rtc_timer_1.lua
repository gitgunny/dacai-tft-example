...
function screen_rtc_timer_1.on_control_notify(screen, control, value)
    ...
    elseif control == change_next_screen_button_id then
        ...
        change_screen(rtc_timer_2_screen_id)
    end
end

return screen_rtc_timer_1
